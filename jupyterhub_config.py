...
c.Authenticator.whitelist = {'jan-frommann', 'fabian-rodriguez', 'David-Horneber', 'Jan-Mihlin', 'Bijendra-Kumar', 'Harshitha-K-P', 'Sourav-Mahanty1', 'Harisha-Cn', 'SHABARI-NATH-Govindankutty'}
