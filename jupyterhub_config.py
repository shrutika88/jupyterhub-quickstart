...
c.GitHubOAuthenticator.admin_users = {'jan-fromann'}
c.GitHubOAuthenticator.allowed_users = {'jan-fromann', 'fabian-rodriguez', 'David-Horneber', 'Jan-Mihlin', 'Bijendra-Kumar', 'Harshitha-K-P', 'Sourav-Mahanty1', 'Harisha-Cn'}
