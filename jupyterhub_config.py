...
c.KubeSpawner.pvc_name_template = 'pvc-nb-{username}'
...
c.Authenticator.admin_users = {'jan-frommann'}
c.Authenticator.whitelist = {'jan-frommann', 'fabian-rodriguez', 'David-Horneber', 'Jan-Mihlin', 'Bijendra-Kumar', 'Harshitha-K-P', 'Sourav-Mahanty1', 'Harisha-Cn', 'SHABARI-NATH-Govindankutty','Shrutika-Yadav'}
